...
class TampilMahasiswa implements KontrakView
{
	...
	function tampil()
	{
		...
		for ($i = 0; $i < $this->prosesmahasiswa->getSize(); $i++) {
			...
			<td>
				<a href='update.php?id=" . $this->prosesmahasiswa->getId($i) . "'>Update</a> |
				<a href='delete.php?id=" . $this->prosesmahasiswa->getId($i) . "' onclick='return confirm(\"Apakah Anda yakin ingin menghapus data ini?\")'>Delete</a>
			</td>
			</tr>";
		}
